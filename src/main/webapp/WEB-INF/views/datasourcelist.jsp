        ...
        <div class="row-fluid section">
            ...
            <div class="block">
                <div class="navbar navbar-inner block-header">
                    <div class="muted pull-left">数据源列表</div>
                </div>
...
$(document).ready(function(){
    ...
    function DataSourceListInit(index,datasourceName,datasourceId,datasetName,datasetId,dataSetType,btn){
        this.index = index;
    ...
    var getalldatasources = function(){
        $.ajax({
            type:"POST",
            async:false,
            url:"/admin/datasetanddatasource",
            data:{},
            dataType:'json',
